// https://hqsinvpur.cpc.com.tw/MAT/OPQ/mtnDQMM06.aspx
const hostname = 'hqsinvpur.cpc.com.tw'
const program = 'mtnDQMM06'
const crawlerMatnos = (matno, data, page = 1) => {
  // data.set('__ASYNCPOST', 'true')
  data.set('ctl00$tbxChangePage', '')
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$ddlDIV', 'M50')
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$ddlMAT_NO_1', matno.substr(0, 1))
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$ddlMAT_NO_1_CascadingDropDown_ClientState', matno.substr(0, 1))
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$ddlMAT_NO_2', matno.substr(1, 1))
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$ddlMAT_NO_2_CascadingDropDown_ClientState', matno.substr(1, 1))
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$tbxMAT_NO_3', matno.substr(2))
  data.set('ctl00$cphBody$TabContainer1$TabPanel1$rblModelQTY', '有庫存(現存)量')
...
// update per day
const scheduleTimes = ['23:30'/*, '07:30', '15:30'*/] // 時:分
setInterval(() => {
  const date = new Date()
